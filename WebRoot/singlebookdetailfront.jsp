	 ...
	 <div class="about-header">
		...
		<div class="container">
                   ...
                   <div class="about-info">
                    ...
                    <img src="${bookdetail.attachment }" width="200px" height="250px" class="center"/>
                    </div>
                  <div class="col-md-9">
                   
                    <p class="text-left"> <h5>Author: ${bookdetail.author }</h5></p>
                    <p class="text-left">${bookdetail.descp }</p>
                    <p class="text-justify"> <h5>Edition: ${bookdetail.publishdate }</h5></p>
                    <br><br><br>
                  </div>
                    </div>
                   <br>
                       ...
                       <tbody>
							...
							<tr>
								...
								<td class="center">${bookdetail.schoolLib.name }</td>
								<td class="center">${state }</td>

								<td class="center"><a class="btn btn-success"
									href="BorrowReturn_borrowBook.action?borrid=${bookdetail.id }"> <i class="glyphicon glyphicon-log-in"></i> Borrow
								</a></td>
							</tr>
