            ...
            <div class="box-content">
             <form role="form">
                 <table  class="table">
                        ...
                        <tr>
                            <td width="30%" colspan="1" align="center"> Book Title</td>
                         ...
                         <tr>
                            <td width="30%" colspan="1" align="center">Genre Select</td>
                        ...
                        <select id="selectError" data-rel="chosen">
                         ...
                         <tr>
                            <td width="30%" colspan="1" align="center"> Author</td>
                         ...
                         <tr>
                            <td width="30%" colspan="1" align="center"> Publishing House</td>
                            
                            <td width="70%" align="center">
                                
                   					  <input type="text" class="form-control" placeholder="Publishing House">
               				   
                          </td>
                        </tr>
                        <tr>
                            <td width="30%" colspan="1" align="center">Date of publiction</td>
                            
                            <td width="70%" align="center">
                                
                   					  <input type="text" class="form-control" placeholder="Date of publiction">
               				   
                          </td>
                        </tr>
                       
                        <tr>
                            <td width="30%" colspan="1" align="center">Front cover</td>
