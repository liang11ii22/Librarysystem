    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Modify Book Information</h2>
            ...
            <div class="box-content">
                <!-- Modify book info start -->
                 
     <form class="form-horizontal"  id="form1" action="Book_updateBookDetails.action" role="form" enctype="multipart/form-data" method="post">
     

      <div class="form-group">
        <label for="name" class="col-sm-3 control-label"><p class="text-center">The Title Of Book</p></label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="name" check-type="required" required-message="${bookdetail.name }" name="book.name" value="${bookdetail.name }">
        </div>
      </div>
       
       <div class="form-group">
        <label for="name" class="col-sm-3 control-label"><p class="text-center">The Author Of The Book</p></label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="name" check-type="required" required-message="${bookdetail.author }" name="book.author" value="${bookdetail.author }">
        </div>
      </div>
      <div class="form-group">
        <label for="name" class="col-sm-3 control-label"><p class="text-center">The Publisher Of The Book</p></label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="name" check-type="required" required-message="${bookdetail.publishment }" name="book.publishment" value="${bookdetail.publishment }">
        </div>
      </div>
  <div class="form-group">
        <label for="name" class="col-sm-3 control-label"><p class="text-center">The Category Of The Book</p></label>
        	<div class="col-sm-5">
     ...
     <div class="form-group">
        <label for="name" class="col-sm-3 control-label"><p class="text-center">The Library Contains The Book</p></label>
        								<div class="col-sm-5">
      ...
      <div class="form-group">
        <label for="name" class="col-sm-3 control-label"><p class="text-center">Edition</p></label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="name" check-type="required" required-message="${bookdetail.publishdate}" name="book.publishdate" value="${bookdetail.publishdate}">
        </div>
      </div>
       
          <div class="form-group ">
          <label for="exampleInputFile" class="col-sm-3 control-label"><p class="text-center">Upload The Cover of The Book</p></label>
...
<div class="form-group">
        <label for="vercode" class="col-sm-3 control-label"><p class="text-center"> Summary Of The Book</p></label>
        <div class="col-sm-6">
        
          <textarea  class="form-control" id="vercode" check-type="required" rows="6" name="book.descp" >${bookdetail.descp}</textarea>
