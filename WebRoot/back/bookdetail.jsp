...
<div class="ch-container">
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            <!-- content starts -->
                ...
                <div class="box-content">
                   <!-- Book Detail Start -->
                    <div class="row">
                   <h2><p class="center">Summary--${bookdetail.name }</small></p></h2>
                     <div class="col-md-3">
                     
                    <img src="${bookdetail.attachment }" width="160px" height="200px" class="center"/>
                    </div>
                  <div class="col-md-9">
                    
                    <p class="text-left"><strong>Author:</strong> ${bookdetail.author }</p>
                    <p class="text-left">${bookdetail.descp }</p>
                    <p class="text-justify"><strong>Edition:</strong> ${bookdetail.publishdate }</p>
                  </div>
                    </div>
    ...
    <footer class="row">
        ...
        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a
                href="http://usman.it/free-responsive-admin-template">Library System</a></p>
    </footer>
