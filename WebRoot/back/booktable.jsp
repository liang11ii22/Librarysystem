        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                  <p class="bg-info"><c:forEach var="slist" items="${slist}">
                    ...
                    <table class="table">
                        ...
                        <tr>
							...
							</a> <a class="btn btn-danger" href="Book_deleteBook.action?bid=${list.id }"> <i class="glyphicon glyphicon-trash icon-white"></i> Delete
							</a></td>
						</tr>
                       </c:forEach>
