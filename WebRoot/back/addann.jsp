   ...
   <!--   <meta charset="utf-8">
	...
	$(function(){
	    ...
	    $("#submit1").on('click',function(event){
	      //第一种提示写法
	      if ($("#form1").valid(this,'Wrong Contents')==false){
	        return false;
	      }
	    })
	    $("#form2").validation();
...
<div class="row">
    <div class="box col-md-12">
     ...
     <form class="form-horizontal"  id="form1" action="Announce_addAnnouncement.action" role="form" method="post">
     

      <div class="form-group">
        <label for="name" class="col-sm-2 control-label">The Title Of Announcementk</label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="name" check-type="required" required-message="Please Full In The Announcement's Title" name="announce.name">
        </div>
      </div>
       ...
       <div class="form-group">
        <label for="vercode" class="col-sm-2 control-label">Entering The Contents Here</label>
        <div class="col-sm-6">
          <textarea  class="form-control" id="vercode" check-type="required" rows="3" name="announce.contents"></textarea>
