...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="booktable.jsp">Booklist</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-book"></i> Book Introduction</h2>

                <div class="box-icon">
                   
                    <a href="index.jsp" class="btn btn-close btn-round btn-default"><i
                ...
                <table class="table table-bordered table-striped responsive">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <small><textarea class="autogrow" readonly="readonly">The legendary author Bruce Eckel brings Java to life with this extraordinarily insightful, and downright funny introduction.</textarea></small>
                        </td>
                    </tr>
                     <tr>
                        <td><h3>Front Cover</h3></td>
                        
                        <td>
                            <img src="img/java1.jpg" class="hidden-xs" width="200" height="250"/>
                        </td>
                    </tr>
