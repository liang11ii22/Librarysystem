            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="Book_showBookList.action"><i
                        ...
                        <li class="accordion">
                         ...
                         <li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="Book_addBookJump.action">Add Book</a></li>
...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="34 new." class="well top-block" href="Announce_annList.action">
            ...
            <div>Bulletin</div>
           <div>13320</div>
            <span class="notification yellow">34 update</span>
        </a>
    </div>
        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-7 col-md-12">
                    <h1>Welcome come to Library System <br>
                        <small></small>
                    </h1>
