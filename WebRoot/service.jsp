...
<html>
<head>
<title>The Public-Library Website Template | Services :: w3layouts</title>
	...
	<div class='h_btm'>
		<div class='cssmenu'>
			<ul>
			    ...
			    <li  class='active' class='has-sub'><a href='service.jsp'><span>Services</span></a></li>
...
<div class="main">
					...
					<div class="services-grids">
						<div class="services-grid">
							<a href="#">Book List</a>
							<p>Book list include all the book items, which are available in the library</p>
						</div>
						<div class="services-grid">
							<a href="#">Checking Maps</a>
							<p>Check the libraries' locations in the camp</p>
						</div>
						<div class="services-grid">
							<a href="#">Personal Information</a>
							<p>Modify you personal information, which include password, username, etc.</p>
						</div>
						<div class="services-grid">
							<a href="#">Reserve Seat</a>
							<p>To improve the efficiency of your study, we provide seat reservation service</p>
						</div>
						 <div class="clear"> </div>
					</div>
				...
				<div class="specials">
					...
					<div class="specials-grids">
						...
						<div class="special-grid spe-grid">
							<img src="./images/pic2.jpg" title="image-name">
							<a href="#">Lorem ipsum dolors</a>
							<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
						</div>
						<div class="clear"> </div>
					</div>
