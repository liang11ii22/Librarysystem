...
<html>
<head>
<title>The Public-Library Website Template | About :: w3layouts</title>
		...
		<div class="about-header">
			...
			<div class="clear"></div>
						...
						<div class="about-info">
							<a href="#">Something related to the Library System</a>
							<p>Our system is to...</p>
						</div>
					<div class="specials">
					...
					<div class="specials-grids">
						<div class="special-grid">
							<img src="./images/f1.jpg" title="image-name" width="290" height="220">
						...
						<div class="special-grid">
							<img src="./images/f3.jpg" title="image-name" width="290" height="220">
							<a href="#">Pre Plans</a>
							<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
						</div>
						<div class="special-grid spe-grid">
							<img src="./images/f2.jpg" title="image-name" width="290" height="220">
							<a href="#">Free Plans</a>
							<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
						</div>
						<div class="clear"> </div>
